#line 1 "Source/FreeRTOS/Common/integer.c"
#line 1 "Source/FreeRTOS/Common/integer.c"

#line 25 "Source/FreeRTOS/Common/integer.c"
 


#line 32 "Source/FreeRTOS/Common/integer.c"
...
#line 34 "Source/FreeRTOS/Common/integer.c"
...
#line 37 "Source/FreeRTOS/Common/integer.c"
...
#line 38 "Source/FreeRTOS/Common/integer.c"


 
#line 1 "Source/FreeRTOS/Common/integer.h"

#line 25 "Source/FreeRTOS/Common/integer.h"
 


#line 29 "Source/FreeRTOS/Common/integer.h"

void vStartIntegerMathTasks( UBaseType_t uxPriority );
BaseType_t xAreIntegerMathsTaskStillRunning( void );

#line 34 "Source/FreeRTOS/Common/integer.h"
#line 41 "Source/FreeRTOS/Common/integer.c"


 
#line 45 "Source/FreeRTOS/Common/integer.c"
#line 46 "Source/FreeRTOS/Common/integer.c"
#line 47 "Source/FreeRTOS/Common/integer.c"
#line 48 "Source/FreeRTOS/Common/integer.c"
#line 49 "Source/FreeRTOS/Common/integer.c"

#line 51 "Source/FreeRTOS/Common/integer.c"

 
#line 54 "Source/FreeRTOS/Common/integer.c"


#line 57 "Source/FreeRTOS/Common/integer.c"
 
static void vCompeteingIntMathTask( void *pvParameters ) ;


#line 62 "Source/FreeRTOS/Common/integer.c"
 
static BaseType_t xTaskCheck[ ( 1 )  ] = { ( BaseType_t ) ( ( BaseType_t ) 0 )  };
...
void vStartIntegerMathTasks( UBaseType_t uxPriority )
{
    ...
    for( sTask = 0; sTask < ( 1 ) ; sTask++ )
    {
        Status = xTaskCreate( vCompeteingIntMathTask, "M02", ( 128 )  , ( void * ) &( xTaskCheck[ sTask ] ), uxPriority, ( TaskHandle_t * ) 0  );
...
#line 88 "Source/FreeRTOS/Common/integer.c"
 
    volatile long lValue;
    short sError = ( ( BaseType_t ) 0 ) ;
    volatile BaseType_t * pxTaskHasExecuted;

    Xprintf("portTASK_FUNCTION() START\r\n");
    
#line 95 "Source/FreeRTOS/Common/integer.c"
...
#line 102 "Source/FreeRTOS/Common/integer.c"
 
        lValue = ( ( long ) 123 ) ;
        lValue += ( ( long ) 234567 ) ;

         
#line 108 "Source/FreeRTOS/Common/integer.c"
#line 112 "Source/FreeRTOS/Common/integer.c"
...
#line 118 "Source/FreeRTOS/Common/integer.c"
 
        if( lValue != ( ( ( ( ( long ) 123 )  + ( ( long ) 234567 )  ) * ( ( long ) -3 )  ) / ( ( long ) 7 )  )  )  
        {
            sError = ( ( BaseType_t ) 1 ) ;
        }

        if( sError == ( ( BaseType_t ) 0 )  )
        {
            
#line 127 "Source/FreeRTOS/Common/integer.c"
 
            POSTINC1 = INTCON; INTCONbits.GIE_GIEH = 0; ;
            *pxTaskHasExecuted = ( ( BaseType_t ) 1 ) ;
            asm( "MOVF	POSTDEC1, 1, 0" ); if( INDF1 & 0x80  ) { INTCONbits.GIE_GIEH = 1; ; } ;
        }

         
#line 135 "Source/FreeRTOS/Common/integer.c"
#line 139 "Source/FreeRTOS/Common/integer.c"
    }
}
...
BaseType_t xAreIntegerMathsTaskStillRunning( void )
{
    ...
    for( sTask = 0; sTask < ( 1 ) ; sTask++ )
    {
        if( xTaskCheck[ sTask ] == ( ( BaseType_t ) 0 )  )
        {
