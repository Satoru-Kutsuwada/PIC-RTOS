#line 1 "Source/serial/serial.c"
#line 1 "Source/serial/serial.c"

#line 25 "Source/serial/serial.c"
 


#line 37 "Source/serial/serial.c"
...
#line 42 "Source/serial/serial.c"
...
#line 43 "Source/serial/serial.c"

#line 1 "Source/FreeRTOS/Common/serial.h"

#line 25 "Source/FreeRTOS/Common/serial.h"
 


#line 29 "Source/FreeRTOS/Common/serial.h"
...
xComPortHandle xSerialPortInit( eCOMPort ePort,
                                ...
                                unsigned char  uxBufferLength );
void vSerialPutString( xComPortHandle pxPort,
                       const signed char * const pcString,
                       unsigned short usStringLength );
signed char  xSerialGetChar( xComPortHandle pxPort,
                                     signed char * pcRxedChar,
                                     TickType_t xBlockTime );
signed char  xSerialPutChar( xComPortHandle pxPort,
                                     signed char cOutChar,
                                     TickType_t xBlockTime );
char  xSerialWaitForSemaphore( xComPortHandle xPort );
void vSerialClose( xComPortHandle xPort );

#line 109 "Source/FreeRTOS/Common/serial.h"
#line 44 "Source/serial/serial.c"
...
#line 45 "Source/serial/serial.c"



#line 51 "Source/serial/serial.c"
...
#line 66 "Source/serial/serial.c"
#line 67 "Source/serial/serial.c"

 
#line 70 "Source/serial/serial.c"
#line 71 "Source/serial/serial.c"
#line 72 "Source/serial/serial.c"
#line 73 "Source/serial/serial.c"
#line 74 "Source/serial/serial.c"
#line 75 "Source/serial/serial.c"
#line 76 "Source/serial/serial.c"
#line 77 "Source/serial/serial.c"
#line 78 "Source/serial/serial.c"

 
#line 81 "Source/serial/serial.c"
...
xComPortHandle xSerialPortInitMinimal( unsigned long ulWantedBaud, unsigned char  uxQueueLength )
{
unsigned long ulBaud;

	
#line 95 "Source/serial/serial.c"
 
	ulBaud = (( unsigned long ) 48000000)   / ulWantedBaud;
	ulBaud /= ( unsigned long ) 16;
	ulBaud -= ( unsigned long ) 1;

	 
	xRxedChars = xQueueGenericCreate( ( uxQueueLength ), ( ( unsigned char  ) sizeof( char ) ), ( ( ( uint8_t ) 0U )  ) ) ;
	xCharsForTx = xQueueGenericCreate( ( uxQueueLength ), ( ( unsigned char  ) sizeof( char ) ), ( ( ( uint8_t ) 0U )  ) ) ;
	...
	POSTINC1 = INTCON; INTCONbits.GIE_GIEH = 0; ;
	{
		...
		TXSTA2bits.BRGH  = ( ( unsigned short ) 1 ) ;
		TXSTA2bits.TXEN  = ( ( unsigned short ) 1 ) ;

		 
		RCSTA2bits.SPEN   = ( ( unsigned short ) 1 ) ;
		RCSTA2bits.CREN  = ( ( unsigned short ) 1 ) ;

		 
		PIE3bits.RC2IE  = ( ( unsigned short ) 1 ) ;
	}
	asm( "MOVF	POSTDEC1, 1, 0" ); if( INDF1 & 0x80  ) { INTCONbits.GIE_GIEH = 1; ; } ;

	
#line 136 "Source/serial/serial.c"
 
	return 0 ;
}
 

xComPortHandle xSerialPortInit( eCOMPort ePort, eBaud eWantedBaud, eParity eWantedParity, eDataBits eWantedDataBits, eStopBits eWantedStopBits, unsigned char  uxBufferLength )
{
	
#line 144 "Source/serial/serial.c"
...
#line 151 "Source/serial/serial.c"
...
signed char  xSerialPutChar( xComPortHandle pxPort, signed char cOutChar, TickType_t xBlockTime )
{
	...
	if( xQueueGenericSend( ( xCharsForTx ), ( ( const void * ) &cOutChar ), ( xBlockTime ), ( ( BaseType_t ) 0 )  )  != ( ( ( BaseType_t ) 1 )  )  )
	{
		return ( ( ( BaseType_t ) 0 )  ) ;
	}

	 
	PIE1bits.TXIE = ( ( unsigned short ) 1 ) ;
...
{
char cChar;
char  xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 ) ;

	
#line 191 "Source/serial/serial.c"
	...
	if( RCSTAbits.OERR )
	{
		RCSTA2bits.CREN   = ( ( unsigned short ) 0 ) ;
		RCSTA2bits.CREN   = ( ( unsigned short ) 1 ) ;
	}

	xQueueGenericSendFromISR( ( xRxedChars ), ( ( const void * ) &cChar ), ( &xHigherPriorityTaskWoken ), ( ( BaseType_t ) 0 )  ) ;
...
void vSerialTxISR( void )
{
char cChar, cTaskWoken = ( ( BaseType_t ) 0 ) ;

	if( xQueueReceiveFromISR( xCharsForTx, &cChar, &cTaskWoken ) == ( ( BaseType_t ) 1 )  )
	{
	...
	else
	{
		...
		PIE1bits.TXIE = ( ( unsigned short ) 0 ) ;
	}
}
