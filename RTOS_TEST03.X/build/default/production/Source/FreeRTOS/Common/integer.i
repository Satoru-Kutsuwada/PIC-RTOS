# 1 "Source/FreeRTOS/Common/integer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Source/FreeRTOS/Common/integer.c" 2
# 34 "Source/FreeRTOS/Common/integer.c"
...
# 34 "Source/FreeRTOS/Common/integer.c" 2
...
# 37 "Source/FreeRTOS/Common/integer.c" 2
...
# 38 "Source/FreeRTOS/Common/integer.c" 2
...
# 41 "Source/FreeRTOS/Common/integer.c" 2
# 58 "Source/FreeRTOS/Common/integer.c"
...
# 72 "Source/FreeRTOS/Common/integer.c"
void vStartIntegerMathTasks( UBaseType_t uxPriority )
{
    short sTask;
    BaseType_t Status;
    ...
    {
        Status = xTaskCreate( vCompeteingIntMathTask, "M02", ( 128 ), ( void * ) &( xTaskCheck[ sTask ] ), uxPriority, ( TaskHandle_t * ) ((void*)0) );
...
static void vCompeteingIntMathTask( void *pvParameters )
{
    ...
    for( ; ; )
    {
        ...
        lValue = ( ( long ) 123 );
        lValue += ( ( long ) 234567 );
# 114 "Source/FreeRTOS/Common/integer.c"
        lValue *= ( ( long ) -3 );
        lValue /= ( ( long ) 7 );
