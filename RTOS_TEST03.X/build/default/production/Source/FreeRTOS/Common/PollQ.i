# 1 "Source/FreeRTOS/Common/PollQ.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Source/FreeRTOS/Common/PollQ.c" 2
# 57 "Source/FreeRTOS/Common/PollQ.c"
...
# 57 "Source/FreeRTOS/Common/PollQ.c" 2
...
# 60 "Source/FreeRTOS/Common/PollQ.c" 2
...
# 61 "Source/FreeRTOS/Common/PollQ.c" 2
...
# 62 "Source/FreeRTOS/Common/PollQ.c" 2
...
# 65 "Source/FreeRTOS/Common/PollQ.c" 2
# 76 "Source/FreeRTOS/Common/PollQ.c"
...
void vStartPolledQueueTasks( UBaseType_t uxPriority )
{
    ...
    if( xPolledQueue != ((void*)0) )
    {
        ...
        Status = xTaskCreate( vPolledQueueConsumer, "Q03", ( 128 ), ( void * ) &xPolledQueue, uxPriority, ( TaskHandle_t * ) ((void*)0) );
         Xprintf("pollQ.c %d Status=%d\r\n",109,Status);
        Status = xTaskCreate( vPolledQueueProducer, "Q04", ( 128 ), ( void * ) &xPolledQueue, uxPriority, ( TaskHandle_t * ) ((void*)0) );
         Xprintf("pollQ.c %d Status=%d\r\n",111,Status);
    }
}
