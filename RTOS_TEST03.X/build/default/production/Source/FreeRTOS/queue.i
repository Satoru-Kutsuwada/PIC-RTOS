...
# 2 "<built-in>" 2
# 1 "Source/FreeRTOS/queue.c" 2
# 29 "Source/FreeRTOS/queue.c"
...
# 354 "Source/FreeRTOS/include\\FreeRTOS.h"
void Xprintf(const char *string, ...);
# 1247 "Source/FreeRTOS/include\\FreeRTOS.h"
...
# 1302 "Source/FreeRTOS/include\\FreeRTOS.h"
...
# 1337 "Source/FreeRTOS/include\\FreeRTOS.h"
        uint32_t ulDummy18[ 1 ];
        uint8_t ucDummy19[ 1 ];
# 1350 "Source/FreeRTOS/include\\FreeRTOS.h"
} StaticTask_t;
# 1366 "Source/FreeRTOS/include\\FreeRTOS.h"
typedef struct xSTATIC_QUEUE
{
    ...
    uint8_t ucDummy5[ 2 ];
# 1389 "Source/FreeRTOS/include\\FreeRTOS.h"
        UBaseType_t uxDummy8;
        uint8_t ucDummy9;

} StaticQueue_t;
typedef StaticQueue_t StaticSemaphore_t;
# 1409 "Source/FreeRTOS/include\\FreeRTOS.h"
...
# 1437 "Source/FreeRTOS/include\\FreeRTOS.h"
...
# 1464 "Source/FreeRTOS/include\\FreeRTOS.h"
...
# 38 "Source/FreeRTOS/queue.c" 2

# 1 "Source/FreeRTOS/include\\queue.h" 1
...
# 657 "Source/FreeRTOS/include\\queue.h"
BaseType_t xQueueGenericSend( QueueHandle_t xQueue,
                              const void * const pvItemToQueue,
                              TickType_t xTicksToWait,
                              const BaseType_t xCopyPosition ) ;
# 755 "Source/FreeRTOS/include\\queue.h"
BaseType_t xQueuePeek( QueueHandle_t xQueue,
                       void * const pvBuffer,
                       TickType_t xTicksToWait ) ;
# 791 "Source/FreeRTOS/include\\queue.h"
...
BaseType_t xQueueReceive( QueueHandle_t xQueue,
                          void * const pvBuffer,
                          TickType_t xTicksToWait ) ;
# 903 "Source/FreeRTOS/include\\queue.h"
UBaseType_t uxQueueMessagesWaiting( const QueueHandle_t xQueue ) ;
# 922 "Source/FreeRTOS/include\\queue.h"
UBaseType_t uxQueueSpacesAvailable( const QueueHandle_t xQueue ) ;
# 938 "Source/FreeRTOS/include\\queue.h"
...
# 1438 "Source/FreeRTOS/include\\queue.h"
...
# 1549 "Source/FreeRTOS/include\\queue.h"
    QueueHandle_t xQueueGenericCreate( const UBaseType_t uxQueueLength,
                                       const UBaseType_t uxItemSize,
                                       const uint8_t ucQueueType ) ;
# 1615 "Source/FreeRTOS/include\\queue.h"
QueueSetHandle_t xQueueCreateSet( const UBaseType_t uxEventQueueLength ) ;
# 1639 "Source/FreeRTOS/include\\queue.h"
BaseType_t xQueueAddToSet( QueueSetMemberHandle_t xQueueOrSemaphore,
                           QueueSetHandle_t xQueueSet ) ;
# 1659 "Source/FreeRTOS/include\\queue.h"
BaseType_t xQueueRemoveFromSet( QueueSetMemberHandle_t xQueueOrSemaphore,
                                QueueSetHandle_t xQueueSet ) ;
# 1696 "Source/FreeRTOS/include\\queue.h"
...
# 39 "Source/FreeRTOS/queue.c" 2
# 69 "Source/FreeRTOS/queue.c"
...
static void prvCopyDataFromQueue( Queue_t * const pxQueue,
                                  void * const pvBuffer ) ;
# 219 "Source/FreeRTOS/queue.c"
static void prvInitialiseNewQueue( const UBaseType_t uxQueueLength,
                                   const UBaseType_t uxItemSize,
                                   uint8_t * pucQueueStorage,
                                   const uint8_t ucQueueType,
                                   Queue_t * pxNewQueue ) ;
# 296 "Source/FreeRTOS/queue.c"
BaseType_t xQueueGenericReset( QueueHandle_t xQueue,
                               BaseType_t xNewQueue )
{
    ...
    if( ( pxQueue != ((void*)0) ) &&
        ...
        ( ( (0xffff) / pxQueue->uxLength ) >= pxQueue->uxItemSize ) )
    {
...
# 428 "Source/FreeRTOS/queue.c"
                                       ...
                                       const uint8_t ucQueueType )
    {
        ...
        if( ( uxQueueLength > ( UBaseType_t ) 0 ) &&
            ...
            ( ( (0xffff) / uxQueueLength ) >= uxItemSize ) &&

            ( ( (0xffff) - sizeof( Queue_t ) ) >= ( uxQueueLength * uxItemSize ) ) )
        {



            xQueueSizeInBytes = ( size_t ) ( uxQueueLength * uxItemSize );
# 456 "Source/FreeRTOS/queue.c"
...
# 536 "Source/FreeRTOS/queue.c"
                                   ;
}
# 835 "Source/FreeRTOS/queue.c"
BaseType_t xQueueGenericSend( QueueHandle_t xQueue,
                              const void * const pvItemToQueue,
                              TickType_t xTicksToWait,
                              const BaseType_t xCopyPosition )
...
# 929 "Source/FreeRTOS/queue.c"
        ...
        vTaskSuspendAll();
        POSTINC1 = INTCON; INTCONbits.GIE_GIEH = 0;; { if( ( pxQueue )->cRxLock == ( ( int8_t ) -1 ) ) { ( pxQueue )->cRxLock = ( ( int8_t ) 0 ); } if( ( pxQueue )->cTxLock == ( ( int8_t ) -1 ) ) { ( pxQueue )->cTxLock = ( ( int8_t ) 0 ); } } __asm("MOVF	POSTDEC1, 1, 0"); if( INDF1 & 0x80 ) { INTCONbits.GIE_GIEH = 1;; };
                              ...
                              BaseType_t * const pxHigherPriorityTaskWoken )
{
    ...
    if( ( !( ( pxQueue->pcHead == ((void*)0) ) && ( pxQueue->u.xSemaphore.xMutexHolder != ((void*)0) ) ) ) == 0 ) Xprintf("ASSERT:%s:%d\r\n" "Source/FreeRTOS/queue.c", 1234 );
# 1250 "Source/FreeRTOS/queue.c"
                                              ;
                          ...
                          TickType_t xTicksToWait )
{
    ...
    if( ( !( ( ( pvBuffer ) == ((void*)0) ) && ( ( pxQueue )->uxItemSize != ( UBaseType_t ) 0U ) ) ) == 0 ) Xprintf("ASSERT:%s:%d\r\n" "Source/FreeRTOS/queue.c", 1391 );
# 1403 "Source/FreeRTOS/queue.c"
    for( ; ; )
    {
        POSTINC1 = INTCON; INTCONbits.GIE_GIEH = 0;;
        {
...
void vQueueDelete( QueueHandle_t xQueue )
{
    ...
    if( ( pxQueue ) == 0 ) Xprintf("ASSERT:%s:%d\r\n" "Source/FreeRTOS/queue.c", 2079 );
                                ;
# 2089 "Source/FreeRTOS/queue.c"
    {


        vPortFree( pxQueue );
    }
# 2114 "Source/FreeRTOS/queue.c"
}
