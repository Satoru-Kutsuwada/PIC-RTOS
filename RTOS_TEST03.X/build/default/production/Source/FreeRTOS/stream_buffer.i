# 1 "Source/FreeRTOS/stream_buffer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Source/FreeRTOS/stream_buffer.c" 2
# 30 "Source/FreeRTOS/stream_buffer.c"
...
# 31 "Source/FreeRTOS/stream_buffer.c" 2
...
# 32 "Source/FreeRTOS/stream_buffer.c" 2
...
# 40 "Source/FreeRTOS/stream_buffer.c" 2
...
# 41 "Source/FreeRTOS/stream_buffer.c" 2
# 1 "Source/FreeRTOS/include\\stream_buffer.h" 1
# 71 "Source/FreeRTOS/include\\stream_buffer.h"
...
# 355 "Source/FreeRTOS/include\\stream_buffer.h"
size_t xStreamBufferSend( StreamBufferHandle_t xStreamBuffer,
                          const void * pvTxData,
                          size_t xDataLengthBytes,
                          TickType_t xTicksToWait ) ;
# 456 "Source/FreeRTOS/include\\stream_buffer.h"
size_t xStreamBufferSendFromISR( StreamBufferHandle_t xStreamBuffer,
                                 const void * pvTxData,
                                 size_t xDataLengthBytes,
                                 BaseType_t * const pxHigherPriorityTaskWoken ) ;
# 545 "Source/FreeRTOS/include\\stream_buffer.h"
size_t xStreamBufferReceive( StreamBufferHandle_t xStreamBuffer,
                             void * pvRxData,
                             size_t xBufferLengthBytes,
                             TickType_t xTicksToWait ) ;
# 631 "Source/FreeRTOS/include\\stream_buffer.h"
size_t xStreamBufferReceiveFromISR( StreamBufferHandle_t xStreamBuffer,
                                    void * pvRxData,
                                    size_t xBufferLengthBytes,
                                    BaseType_t * const pxHigherPriorityTaskWoken ) ;
# 656 "Source/FreeRTOS/include\\stream_buffer.h"
void vStreamBufferDelete( StreamBufferHandle_t xStreamBuffer ) ;
# 676 "Source/FreeRTOS/include\\stream_buffer.h"
BaseType_t xStreamBufferIsFull( StreamBufferHandle_t xStreamBuffer ) ;
# 696 "Source/FreeRTOS/include\\stream_buffer.h"
BaseType_t xStreamBufferIsEmpty( StreamBufferHandle_t xStreamBuffer ) ;
# 719 "Source/FreeRTOS/include\\stream_buffer.h"
BaseType_t xStreamBufferReset( StreamBufferHandle_t xStreamBuffer ) ;
# 740 "Source/FreeRTOS/include\\stream_buffer.h"
size_t xStreamBufferSpacesAvailable( StreamBufferHandle_t xStreamBuffer ) ;
# 761 "Source/FreeRTOS/include\\stream_buffer.h"
size_t xStreamBufferBytesAvailable( StreamBufferHandle_t xStreamBuffer ) ;
# 798 "Source/FreeRTOS/include\\stream_buffer.h"
BaseType_t xStreamBufferSetTriggerLevel( StreamBufferHandle_t xStreamBuffer,
                                         size_t xTriggerLevel ) ;
# 838 "Source/FreeRTOS/include\\stream_buffer.h"
BaseType_t xStreamBufferSendCompletedFromISR( StreamBufferHandle_t xStreamBuffer,
                                              BaseType_t * pxHigherPriorityTaskWoken ) ;
# 879 "Source/FreeRTOS/include\\stream_buffer.h"
...
# 42 "Source/FreeRTOS/stream_buffer.c" 2
# 223 "Source/FreeRTOS/stream_buffer.c"
...
# 260 "Source/FreeRTOS/stream_buffer.c"
static size_t prvWriteBytesToBuffer( StreamBuffer_t * const pxStreamBuffer,
                                     const uint8_t * pucData,
                                     size_t xCount,
                                     size_t xHead ) ;
# 272 "Source/FreeRTOS/stream_buffer.c"
static size_t prvReadMessageFromBuffer( StreamBuffer_t * pxStreamBuffer,
                                        void * pvRxData,
                                        size_t xBufferLengthBytes,
                                        size_t xBytesAvailable ) ;
# 284 "Source/FreeRTOS/stream_buffer.c"
static size_t prvWriteMessageToBuffer( StreamBuffer_t * const pxStreamBuffer,
                                       const void * pvTxData,
                                       size_t xDataLengthBytes,
                                       size_t xSpace,
                                       size_t xRequiredSpace ) ;
# 302 "Source/FreeRTOS/stream_buffer.c"
...
# 364 "Source/FreeRTOS/stream_buffer.c"
        ...
        {
            pucAllocatedMemory = ((void*)0);
        }

        if( pucAllocatedMemory != ((void*)0) )
        {
...
# 477 "Source/FreeRTOS/stream_buffer.c"
void vStreamBufferDelete( StreamBufferHandle_t xStreamBuffer )
{
...
BaseType_t xStreamBufferReset( StreamBufferHandle_t xStreamBuffer )
{
    ...
    StreamBufferCallbackFunction_t pxSendCallback = ((void*)0), pxReceiveCallback = ((void*)0);
    ...
    {
        if( ( pxStreamBuffer->xTaskWaitingToReceive == ((void*)0) ) && ( pxStreamBuffer->xTaskWaitingToSend == ((void*)0) ) )
        {
                          ...
                          TickType_t xTicksToWait )
{
        ...
        do
        {
            ...
            POSTINC1 = INTCON; INTCONbits.GIE_GIEH = 0;;
            {
                ...
                if( xSpace < xRequiredSpace )
                {
                    ...
                    ( void ) xTaskGenericNotifyStateClear( ( ((void*)0) ), ( ( 0 ) ) );


                    if( ( pxStreamBuffer->xTaskWaitingToSend == ((void*)0) ) == 0 ) Xprintf("ASSERT:%s:%d\r\n" "Source/FreeRTOS/stream_buffer.c", 718 );
            ...
            __asm("MOVF	POSTDEC1, 1, 0"); if( INDF1 & 0x80 ) { INTCONbits.GIE_GIEH = 1;; };
                                                                ...
                                                                ;
            ( void ) xTaskGenericNotifyWait( ( 0 ), ( ( uint32_t ) 0 ), ( ( uint32_t ) 0 ), ( ((void*)0) ), ( xTicksToWait ) );
            pxStreamBuffer->xTaskWaitingToSend = ((void*)0);
    ...
    if( xReturn > ( size_t ) 0 )
    {
        ...
        {
            vTaskSuspendAll(); { if( ( ( pxStreamBuffer ) )->xTaskWaitingToReceive != ((void*)0) ) { ( void ) xTaskGenericNotify( ( ( ( pxStreamBuffer ) )->xTaskWaitingToReceive ), ( ( 0 ) ), ( ( uint32_t ) 0 ), ( eNoAction ), ((void*)0) ); ( ( pxStreamBuffer ) )->xTaskWaitingToReceive = ((void*)0); } } ( void ) xTaskResumeAll();;
        }
        else
        {
                                    ;
                                 ...
                                 BaseType_t * const pxHigherPriorityTaskWoken )
{
    ...
    if( xReturn > ( size_t ) 0 )
    {
        ...
        if( prvBytesInBuffer( pxStreamBuffer ) >= pxStreamBuffer->xTriggerLevelBytes )
        {
            { UBaseType_t uxSavedInterruptStatus; uxSavedInterruptStatus = ( UBaseType_t ) 0; { if( ( ( pxStreamBuffer ) )->xTaskWaitingToReceive != ((void*)0) ) { ( void ) xTaskGenericNotifyFromISR( ( ( ( pxStreamBuffer ) )->xTaskWaitingToReceive ), ( ( 0 ) ), ( ( uint32_t ) 0 ), ( eNoAction ), ((void*)0), ( ( ( pxHigherPriorityTaskWoken ) ) ) ); ( ( pxStreamBuffer ) )->xTaskWaitingToReceive = ((void*)0); } } ( void ) ( uxSavedInterruptStatus ); };
        }
        else
        {
                                    ;
                             ...
                             TickType_t xTicksToWait )
{
    ...
    if( xTicksToWait != ( TickType_t ) 0 )
    {
        ...
        POSTINC1 = INTCON; INTCONbits.GIE_GIEH = 0;;
        {
            ...
            if( xBytesAvailable <= xBytesToStoreMessageLength )
            {
                ...
                if( ( pxStreamBuffer->xTaskWaitingToReceive == ((void*)0) ) == 0 ) Xprintf("ASSERT:%s:%d\r\n" "Source/FreeRTOS/stream_buffer.c", 919 );
        ...
        if( xBytesAvailable <= xBytesToStoreMessageLength )
        {
                                                                   ...
                                                                   ;
            ( void ) xTaskGenericNotifyWait( ( 0 ), ( ( uint32_t ) 0 ), ( ( uint32_t ) 0 ), ( ((void*)0) ), ( xTicksToWait ) );
            pxStreamBuffer->xTaskWaitingToReceive = ((void*)0);
    ...
    if( xBytesAvailable > xBytesToStoreMessageLength )
    {
        ...
        {
                                                                        ;
            vTaskSuspendAll(); { if( ( ( xStreamBuffer ) )->xTaskWaitingToSend != ((void*)0) ) { ( void ) xTaskGenericNotify( ( ( ( xStreamBuffer ) )->xTaskWaitingToSend ), ( ( 0 ) ), ( ( uint32_t ) 0 ), ( eNoAction ), ((void*)0) ); ( ( xStreamBuffer ) )->xTaskWaitingToSend = ((void*)0); } } ( void ) xTaskResumeAll();;
        }
        else
        {
                                    ;
                                    ...
                                    BaseType_t * const pxHigherPriorityTaskWoken )
{
    ...
    if( xBytesAvailable > xBytesToStoreMessageLength )
    {
        ...
        if( xReceivedLength != ( size_t ) 0 )
        {
            { UBaseType_t uxSavedInterruptStatus; uxSavedInterruptStatus = ( UBaseType_t ) 0; { if( ( ( pxStreamBuffer ) )->xTaskWaitingToSend != ((void*)0) ) { ( void ) xTaskGenericNotifyFromISR( ( ( ( pxStreamBuffer ) )->xTaskWaitingToSend ), ( ( 0 ) ), ( ( uint32_t ) 0 ), ( eNoAction ), ((void*)0), ( ( ( pxHigherPriorityTaskWoken ) ) ) ); ( ( pxStreamBuffer ) )->xTaskWaitingToSend = ((void*)0); } } ( void ) ( uxSavedInterruptStatus ); };
        }
        else
        {
                                    ;
                                              ...
                                              BaseType_t * pxHigherPriorityTaskWoken )
{
    ...
    {
        if( ( pxStreamBuffer )->xTaskWaitingToReceive != ((void*)0) )
        {
            ( void ) xTaskGenericNotifyFromISR( ( ( pxStreamBuffer )->xTaskWaitingToReceive ), ( ( 0 ) ), ( ( uint32_t ) 0 ), ( eNoAction ), ((void*)0), ( pxHigherPriorityTaskWoken ) );
                                                 ...
                                                 BaseType_t * pxHigherPriorityTaskWoken )
{
    ...
    uxSavedInterruptStatus = ( UBaseType_t ) 0;
    {
        if( ( pxStreamBuffer )->xTaskWaitingToSend != ((void*)0) )
        {
            ( void ) xTaskGenericNotifyFromISR( ( ( pxStreamBuffer )->xTaskWaitingToSend ), ( ( 0 ) ), ( ( uint32_t ) 0 ), ( eNoAction ), ((void*)0), ( pxHigherPriorityTaskWoken ) );
...
static void prvInitialiseNewStreamBuffer( StreamBuffer_t * const pxStreamBuffer,
                                          ...
                                          StreamBufferCallbackFunction_t pxReceiveCompletedCallback )
{
# 1381 "Source/FreeRTOS/stream_buffer.c"
