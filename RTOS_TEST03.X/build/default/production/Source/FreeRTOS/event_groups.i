# 1 "Source/FreeRTOS/event_groups.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Source/FreeRTOS/event_groups.c" 2
# 30 "Source/FreeRTOS/event_groups.c"
...
# 30 "Source/FreeRTOS/event_groups.c" 2
...
# 38 "Source/FreeRTOS/event_groups.c" 2
...
# 39 "Source/FreeRTOS/event_groups.c" 2
...
# 40 "Source/FreeRTOS/event_groups.c" 2

# 1 "Source/FreeRTOS/include\\event_groups.h" 1
# 82 "Source/FreeRTOS/include\\event_groups.h"
struct EventGroupDef_t;
typedef struct EventGroupDef_t * EventGroupHandle_t;
# 93 "Source/FreeRTOS/include\\event_groups.h"
typedef TickType_t EventBits_t;
# 148 "Source/FreeRTOS/include\\event_groups.h"
    EventGroupHandle_t xEventGroupCreate( void ) ;
# 297 "Source/FreeRTOS/include\\event_groups.h"
EventBits_t xEventGroupWaitBits( EventGroupHandle_t xEventGroup,
                                 const EventBits_t uxBitsToWaitFor,
                                 const BaseType_t xClearOnExit,
                                 const BaseType_t xWaitForAllBits,
                                 TickType_t xTicksToWait ) ;
# 358 "Source/FreeRTOS/include\\event_groups.h"
EventBits_t xEventGroupClearBits( EventGroupHandle_t xEventGroup,
                                  const EventBits_t uxBitsToClear ) ;
# 422 "Source/FreeRTOS/include\\event_groups.h"
    BaseType_t xEventGroupClearBitsFromISR( EventGroupHandle_t xEventGroup,
                                            const EventBits_t uxBitsToClear ) ;
# 501 "Source/FreeRTOS/include\\event_groups.h"
EventBits_t xEventGroupSetBits( EventGroupHandle_t xEventGroup,
                                const EventBits_t uxBitsToSet ) ;
# 577 "Source/FreeRTOS/include\\event_groups.h"
    BaseType_t xEventGroupSetBitsFromISR( EventGroupHandle_t xEventGroup,
                                          const EventBits_t uxBitsToSet,
                                          BaseType_t * pxHigherPriorityTaskWoken ) ;
# 709 "Source/FreeRTOS/include\\event_groups.h"
EventBits_t xEventGroupSync( EventGroupHandle_t xEventGroup,
                             const EventBits_t uxBitsToSet,
                             const EventBits_t uxBitsToWaitFor,
                             TickType_t xTicksToWait ) ;
# 748 "Source/FreeRTOS/include\\event_groups.h"
EventBits_t xEventGroupGetBitsFromISR( EventGroupHandle_t xEventGroup ) ;
# 762 "Source/FreeRTOS/include\\event_groups.h"
...
# 41 "Source/FreeRTOS/event_groups.c" 2
# 64 "Source/FreeRTOS/event_groups.c"
...
# 88 "Source/FreeRTOS/event_groups.c"
static BaseType_t prvTestWaitCondition( const EventBits_t uxCurrentEventBits,
                                        const EventBits_t uxBitsToWaitFor,
                                        const BaseType_t xWaitForAllBits ) ;
# 148 "Source/FreeRTOS/event_groups.c"
    EventGroupHandle_t xEventGroupCreate( void )
    {
        EventGroup_t * pxEventBits;
# 165 "Source/FreeRTOS/event_groups.c"
...
# 181 "Source/FreeRTOS/event_groups.c"
                                                  ;
        }
        else
        {
...
# 517 "Source/FreeRTOS/event_groups.c"
EventBits_t xEventGroupGetBitsFromISR( EventGroupHandle_t xEventGroup )
{
...
# 672 "Source/FreeRTOS/event_groups.c"
}
...
# 749 "Source/FreeRTOS/event_groups.c"
    UBaseType_t uxEventGroupGetNumber( void * xEventGroup )
    {
        UBaseType_t xReturn;
