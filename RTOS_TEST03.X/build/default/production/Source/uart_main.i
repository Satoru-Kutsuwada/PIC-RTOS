        ...
        *ap = __va_start();
        ...
        while (*string != '\0') {
            if (*string == '%') {
                ...
                switch (*string ){
                    case 'c':
                        ch = (*(char *)__va_arg(*(char **)ap, (char)0));

                        buffer = my_putchar(ch, buffer );
                        break;
                    case 'd':
                        intvalue = (*(int *)__va_arg(*(int **)ap, (int)0));

                        buffer = my_putint(intvalue, buffer);
                        break;
                    case 'f':
                        floatvalue = (*(double *)__va_arg(*(double **)ap, (double)0));
                        buffer = my_putfloat(floatvalue, 2, buffer );
                        break;
                    case 's':
                        charvalue = (*(char* *)__va_arg(*(char* **)ap, (char*)0));
                        buffer = my_puts(charvalue, buffer );
                        break;
                    case 'x':
                        uintvalue = (uint16_t)(*(int *)__va_arg(*(int **)ap, (int)0));
