...
# 1 "Source/FreeRTOS/include\\semphr.h" 1
# 36 "Source/FreeRTOS/include\\semphr.h"
...
# 36 "Source/FreeRTOS/include\\semphr.h" 2
...
# 1 "Source/FreeRTOS/Common\\PollQ.h" 1
# 30 "Source/FreeRTOS/Common\\PollQ.h"
void vStartPolledQueueTasks( UBaseType_t uxPriority );
BaseType_t xArePollingQueuesStillRunning( void );
# 75 "Source/main1.c" 2

# 1 "Source/FreeRTOS/Common\\integer.h" 1
# 30 "Source/FreeRTOS/Common\\integer.h"
void vStartIntegerMathTasks( UBaseType_t uxPriority );
BaseType_t xAreIntegerMathsTaskStillRunning( void );
# 76 "Source/main1.c" 2

# 1 "Source/FreeRTOS/Common\\partest.h" 1
# 32 "Source/FreeRTOS/Common\\partest.h"
...
void Wait(uint16_t num)
{
     ...
     for (i=0 ; i < num ; i++) {
          _delay((unsigned long)((10)*((( unsigned long ) 48000000)/4000.0))) ;
     }
}
# 480 "Source/main1.c"
void main( void )
...
void task002( void *pvParameters )
{
    ...
    do { if( isr_cnt < 10 ){ const char* _s = ("task002 -------------------"); while (*_s) { { while (!TXSTA2bits.TRMT); TXREG2 = (*_s); }; _s++; } { while (!TXSTA2bits.TRMT); TXREG2 = (ConvC[( 1 >> 4 ) & 0x0f ]); }; { while (!TXSTA2bits.TRMT); TXREG2 = (ConvC[( 1 & 0x0f)]); }; { while (!TXSTA2bits.TRMT); TXREG2 = ('\r'); }; { while (!TXSTA2bits.TRMT); TXREG2 = ('\n'); }; } } while (0);
...
{
    do { if( isr_cnt < 10 ){ const char* _s = ("task001 -------------------"); while (*_s) { { while (!TXSTA2bits.TRMT); TXREG2 = (*_s); }; _s++; } { while (!TXSTA2bits.TRMT); TXREG2 = (ConvC[( 1 >> 4 ) & 0x0f ]); }; { while (!TXSTA2bits.TRMT); TXREG2 = (ConvC[( 1 & 0x0f)]); }; { while (!TXSTA2bits.TRMT); TXREG2 = ('\r'); }; { while (!TXSTA2bits.TRMT); TXREG2 = ('\n'); }; } } while (0);
...
static char prvCheckOtherTasksAreStillRunning( void )
{
char xErrorHasOccurred = ( ( BaseType_t ) 0 );

 if( xAreIntegerMathsTaskStillRunning() != ( ( BaseType_t ) 1 ) )
 {
  xErrorHasOccurred = ( ( BaseType_t ) 1 );
 }
