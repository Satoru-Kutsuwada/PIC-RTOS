#line 1 "Source/FreeRTOS/portable/PIC18F/port.c"
#line 1 "Source/FreeRTOS/portable/PIC18F/port.c"


#line 28 "Source/FreeRTOS/portable/PIC18F/port.c"
 


#line 57 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 60 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 61 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 64 "Source/FreeRTOS/portable/PIC18F/port.c"


#line 1 "Source/rtc_main.h"

#line 6 "Source/rtc_main.h"
 


#line 10 "Source/rtc_main.h"

#line 14 "Source/rtc_main.h"
...
#line 34 "Source/rtc_main.h"

#line 36 "Source/rtc_main.h"

#line 66 "Source/FreeRTOS/portable/PIC18F/port.c"

RTC_DATA RTCdt;


#line 71 "Source/FreeRTOS/portable/PIC18F/port.c"
 

 
#line 75 "Source/FreeRTOS/portable/PIC18F/port.c"


#line 77 "Source/FreeRTOS/portable/PIC18F/port.c"
 
#line 79 "Source/FreeRTOS/portable/PIC18F/port.c"

 
#line 82 "Source/FreeRTOS/portable/PIC18F/port.c"


#line 84 "Source/FreeRTOS/portable/PIC18F/port.c"
 
#line 86 "Source/FreeRTOS/portable/PIC18F/port.c"


#line 90 "Source/FreeRTOS/portable/PIC18F/port.c"
 
#line 92 "Source/FreeRTOS/portable/PIC18F/port.c"


#line 94 "Source/FreeRTOS/portable/PIC18F/port.c"
 
typedef void TCB_t;
extern volatile TCB_t * volatile pxCurrentTCB;

 
#line 100 "Source/FreeRTOS/portable/PIC18F/port.c"
#line 101 "Source/FreeRTOS/portable/PIC18F/port.c"


#line 105 "Source/FreeRTOS/portable/PIC18F/port.c"
 
void vSerialTxISR( void );
void vSerialRxISR( void );


#line 111 "Source/FreeRTOS/portable/PIC18F/port.c"
 
static void prvSetupTimerInterrupt( void );


#line 117 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 125 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 145 "Source/FreeRTOS/portable/PIC18F/port.c"
#line 146 "Source/FreeRTOS/portable/PIC18F/port.c"


#line 153 "Source/FreeRTOS/portable/PIC18F/port.c"
#line 154 "Source/FreeRTOS/portable/PIC18F/port.c"
    

#line 203 "Source/FreeRTOS/portable/PIC18F/port.c"
 


#line 264 "Source/FreeRTOS/portable/PIC18F/port.c"
#line 265 "Source/FreeRTOS/portable/PIC18F/port.c"
{ { while (!TXSTA2bits.TRMT ); TXREG2  = ('@'); } ; { while (!TXSTA2bits.TRMT ); TXREG2  = (ConvC[( STKPTR >> 4 ) & 0x0f ]); } ; { while (!TXSTA2bits.TRMT ); TXREG2  = (ConvC[( STKPTR & 0x0f)]); } ; { while (!TXSTA2bits.TRMT ); TXREG2  = ('@'); } ; } ;        																	{ { while (!TXSTA2bits.TRMT ); TXREG2  = ('@'); } ; { while (!TXSTA2bits.TRMT ); TXREG2  = (ConvC[( STKPTR >> 4 ) & 0x0f ]); } ; { while (!TXSTA2bits.TRMT ); TXREG2  = (ConvC[( STKPTR & 0x0f)]); } ; { while (!TXSTA2bits.TRMT ); TXREG2  = ('@'); } ; } ;        																																							 								while( STKPTR > ( uint8_t ) 0 )                                     			{																					asm(																				"MOVFF	TOSL, PREINC1;"															"MOVFF	TOSH, PREINC1;"															"MOVFF	TOSU, PREINC1;"															"POP"																		);                                                                  		}																		{ while (!TXSTA2bits.TRMT ); TXREG2  = ('C'); } ;   																																						asm(																				 															"MOVFF	FSR0L, PREINC1;"															"MOVF	PREINC1, 1, 0"														);                                                                          																					 						asm(																				"MOVFF	(_pxCurrentTCB), FSR0L;"													"MOVFF	(_pxCurrentTCB + 1, FSR0H;"												"MOVFF	FSR1L, POSTINC0;"														"MOVFF	FSR1H, POSTINC0"													);                                                                  		}
#line 294 "Source/FreeRTOS/portable/PIC18F/port.c"


 


#line 300 "Source/FreeRTOS/portable/PIC18F/port.c"
 

#line 308 "Source/FreeRTOS/portable/PIC18F/port.c"

#line 309 "Source/FreeRTOS/portable/PIC18F/port.c"

#line 397 "Source/FreeRTOS/portable/PIC18F/port.c"
#line 398 "Source/FreeRTOS/portable/PIC18F/port.c"
 



#line 403 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 410 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 424 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 436 "Source/FreeRTOS/portable/PIC18F/port.c"
	...
	*pxTopOfStack = ( StackType_t ) 0x88;  
	pxTopOfStack++;

	*pxTopOfStack = ( StackType_t ) 0x99;  
	pxTopOfStack++;

	*pxTopOfStack = ( StackType_t ) 0xaa;  
	pxTopOfStack++;

	*pxTopOfStack = ( StackType_t ) 0xbb;  
	pxTopOfStack++;
	...
	*pxTopOfStack = ( StackType_t ) 0x00;  
	...
	for( ucBlock = 0; ucBlock <= ( ( uint8_t ) 0x13 ) ; ucBlock++ )
	{
	...
	*pxTopOfStack = ( StackType_t ) ( ( uint8_t ) 0x13 ) ;  
	pxTopOfStack++;
...
#line 506 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 524 "Source/FreeRTOS/portable/PIC18F/port.c"
...
BaseType_t xPortStartScheduler( void )
{
	...
	{ asm( "MOVFF	(_pxCurrentTCB), FSR0L;" "MOVFF	(_pxCurrentTCB + 1), FSR0H;" "MOVFF	POSTINC0, FSR1L;" "MOVFF	POSTINC0, FSR1H;" "MOVFF	POSTDEC1, FSR0L;" "MOVFF	POSTDEC1, FSR0L" ); STKPTR = 0; while( STKPTR < FSR0L ) { asm( "PUSH;" "MOVF	POSTDEC1, 0, 0;" "MOVWF	TOSU, 0;" "MOVF	POSTDEC1, 0, 0;" "MOVWF	TOSH, 0;" "MOVF	POSTDEC1, 0, 0;" "MOVWF	TOSL, 0" ); } asm( "MOVFF	POSTDEC1, FSR0H;" "MOVFF	POSTDEC1, FSR0L;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, POSTDEC0;" "MOVFF	POSTDEC1, INDF0;" "MOVFF	POSTDEC1, PCLATH;" "MOVFF	POSTDEC1, PCLATU;" "MOVFF	POSTDEC1, PRODL;" "MOVFF	POSTDEC1, PRODH;" "MOVFF	POSTDEC1, TBLPTRL;" "MOVFF	POSTDEC1, TBLPTRH;" "MOVFF	POSTDEC1, TBLPTRU;" "MOVFF	POSTDEC1, TABLAT;" "MOVFF	POSTDEC1, FSR0H;" "MOVFF	POSTDEC1, FSR0L;" "MOVFF	POSTDEC1, FSR2H;" "MOVFF	POSTDEC1, FSR2L;" "MOVFF	POSTDEC1, BSR;" "MOVFF	POSTDEC1, WREG" ); if( WREG & 0x80  ) { asm( "MOVFF	POSTDEC1, STATUS;" "MOVFF	POSTDEC1, WREG;" "RETFIE	0" ); } else { asm( "MOVFF	POSTDEC1, STATUS;" "MOVFF	POSTDEC1, WREG;" "RETURN	0" ); } } ;
...
#line 564 "Source/FreeRTOS/portable/PIC18F/port.c"
 
}
 


#line 572 "Source/FreeRTOS/portable/PIC18F/port.c"
 
void vPortYield( void )
{
	
#line 576 "Source/FreeRTOS/portable/PIC18F/port.c"
 
	{ asm( "MOVFF	WREG, PREINC1;" "MOVFF   STATUS, PREINC1;" "MOVFF	INTCON, WREG;" "IORLW	(ucForcedInterruptFlags);" "MOVFF	WREG, PREINC1" ); INTCONbits.GIE_GIEH = 0; ; { while (!TXSTA2bits.TRMT ); TXREG2  = ('A'); } ; asm( "MOVFF	BSR, PREINC1;" "MOVFF	FSR2L, PREINC1;" "MOVFF	FSR2H, PREINC1;" "MOVFF	FSR0L, PREINC1;" "MOVFF	FSR0H, PREINC1;" "MOVFF	TABLAT, PREINC1;" "MOVFF	TBLPTRU, PREINC1;" "MOVFF	TBLPTRH, PREINC1;" "MOVFF	TBLPTRL, PREINC1;" "MOVFF	PRODH, PREINC1;" "MOVFF	PRODL, PREINC1;" "MOVFF	PCLATU, PREINC1;" "MOVFF	PCLATH, PREINC1;" "CLRF	FSR0L, 0;" "CLRF	FSR0H, 0;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	INDF0, PREINC1;" "MOVFF	FSR0L, PREINC1;" "MOVFF	FSR0H, PREINC1;" "MOVFF	STKPTR, FSR0L" ); { while (!TXSTA2bits.TRMT ); TXREG2  = ('B'); } ; \ ;
...
#line 589 "Source/FreeRTOS/portable/PIC18F/port.c"
 
#line 599 "Source/FreeRTOS/portable/PIC18F/port.c"




#line 637 "Source/FreeRTOS/portable/PIC18F/port.c"


#line 640 "Source/FreeRTOS/portable/PIC18F/port.c"
#line 641 "Source/FreeRTOS/portable/PIC18F/port.c"
uint16_t timer_cnt;
uint16_t timer_cnt_buf;



#line 659 "Source/FreeRTOS/portable/PIC18F/port.c"

#line 663 "Source/FreeRTOS/portable/PIC18F/port.c"
#line 706 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 714 "Source/FreeRTOS/portable/PIC18F/port.c"
 
        { while (!TXSTA2bits.TRMT ); TXREG2  = ('B'); } ;
        { asm( "MOVFF	WREG, PREINC1;" "MOVFF   STATUS, PREINC1;" "MOVFF	INTCON, WREG;" "IORLW	(ucForcedInterruptFlags);" "MOVFF	WREG, PREINC1" ); INTCONbits.GIE_GIEH = 0; ; { while (!TXSTA2bits.TRMT ); TXREG2  = ('A'); } ; asm( "MOVFF	BSR, PREINC1;" "MOVFF	FSR2L, PREINC1;" "MOVFF	FSR2H, PREINC1;" "MOVFF	FSR0L, PREINC1;" "MOVFF	FSR0H, PREINC1;" "MOVFF	TABLAT, PREINC1;" "MOVFF	TBLPTRU, PREINC1;" "MOVFF	TBLPTRH, PREINC1;" "MOVFF	TBLPTRL, PREINC1;" "MOVFF	PRODH, PREINC1;" "MOVFF	PRODL, PREINC1;" "MOVFF	PCLATU, PREINC1;" "MOVFF	PCLATH, PREINC1;" "CLRF	FSR0L, 0;" "CLRF	FSR0H, 0;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	POSTINC0, PREINC1;" "MOVFF	INDF0, PREINC1;" "MOVFF	FSR0L, PREINC1;" "MOVFF	FSR0H, PREINC1;" "MOVFF	STKPTR, FSR0L" ); { while (!TXSTA2bits.TRMT ); TXREG2  = ('B'); } ; \ ;
...
#line 768 "Source/FreeRTOS/portable/PIC18F/port.c"



#line 772 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 782 "Source/FreeRTOS/portable/PIC18F/port.c"
...
#line 822 "Source/FreeRTOS/portable/PIC18F/port.c"
#line 846 "Source/FreeRTOS/portable/PIC18F/port.c"
}
