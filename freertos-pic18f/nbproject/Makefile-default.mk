...
FINAL_IMAGE=${DISTDIR}/freertos-pic18f.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=freertos/list.c freertos/tasks.c freertos/queue.c freertos/portable/MemMang/heap_2.c freertos/portable/MPLAB/PIC18F/port.c source/main.c source/uart_main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/freertos/list.o ${OBJECTDIR}/freertos/tasks.o ${OBJECTDIR}/freertos/queue.o ${OBJECTDIR}/freertos/portable/MemMang/heap_2.o ${OBJECTDIR}/freertos/portable/MPLAB/PIC18F/port.o ${OBJECTDIR}/source/main.o ${OBJECTDIR}/source/uart_main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/freertos/list.o.d ${OBJECTDIR}/freertos/tasks.o.d ${OBJECTDIR}/freertos/queue.o.d ${OBJECTDIR}/freertos/portable/MemMang/heap_2.o.d ${OBJECTDIR}/freertos/portable/MPLAB/PIC18F/port.o.d ${OBJECTDIR}/source/main.o.d ${OBJECTDIR}/source/uart_main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/freertos/list.o ${OBJECTDIR}/freertos/tasks.o ${OBJECTDIR}/freertos/queue.o ${OBJECTDIR}/freertos/portable/MemMang/heap_2.o ${OBJECTDIR}/freertos/portable/MPLAB/PIC18F/port.o ${OBJECTDIR}/source/main.o ${OBJECTDIR}/source/uart_main.o

# Source Files
SOURCEFILES=freertos/list.c freertos/tasks.c freertos/queue.c freertos/portable/MemMang/heap_2.c freertos/portable/MPLAB/PIC18F/port.c source/main.c source/uart_main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/freertos-pic18f.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/source/uart_main.o: source/uart_main.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/source" 
	@${RM} ${OBJECTDIR}/source/uart_main.o.d 
	@${RM} ${OBJECTDIR}/source/uart_main.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -DPIC18F -I"C:/Program Files (x86)/Microchip/mplabc18/v3.47/h" -I"source" -I"freertos/include" -I"freertos/portable/MPLAB/PIC18F" -I"freertos/portable/Common/include" -ms -oa- -Ls  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/source/uart_main.o   source/uart_main.c 
	@${DEP_GEN} -d ${OBJECTDIR}/source/uart_main.o 
	@${FIXDEPS} "${OBJECTDIR}/source/uart_main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/source/uart_main.o: source/uart_main.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/source/uart_main.o.d 
	@${RM} ${OBJECTDIR}/source/uart_main.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DPIC18F -I"C:/Program Files (x86)/Microchip/mplabc18/v3.47/h" -I"source" -I"freertos/include" -I"freertos/portable/MPLAB/PIC18F" -I"freertos/portable/Common/include" -ms -oa- -Ls  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/source/uart_main.o   source/uart_main.c 
	@${DEP_GEN} -d ${OBJECTDIR}/source/uart_main.o 
	@${FIXDEPS} "${OBJECTDIR}/source/uart_main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/freertos-pic18f.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    source/18f47j53_g.lkr
	@${MKDIR} ${DISTDIR} 
	${MP_LD} $(MP_EXTRA_LD_PRE) "source\18f47j53_g.lkr"  -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 -z__MPLAB_DEBUGGER_PK3=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}\\..\\lib  -o ${DISTDIR}/freertos-pic18f.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
else
${DISTDIR}/freertos-pic18f.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   source/18f47j53_g.lkr
	@${MKDIR} ${DISTDIR} 
	${MP_LD} $(MP_EXTRA_LD_PRE) "source\18f47j53_g.lkr"  -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -o ${DISTDIR}/freertos-pic18f.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
